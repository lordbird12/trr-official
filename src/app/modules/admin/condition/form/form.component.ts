...
import { Service } from '../service/condition.service';
...
export class FormComponent implements OnInit {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                dataTablesParameters.condition_id = this.Id;
                that._service
            ...
            if (result === 'confirmed') {
                ...
                if (!this.Id) {
                    this._service.create(this.addForm.value).subscribe({
                        next: (resp: any) => {
                            this._router
                                .navigateByUrl('admin/condition/list')
                                .then(() => { });
                        },
    ...
    backTo() {
        this._router.navigate(['admin/condition/list']);
    }
}
